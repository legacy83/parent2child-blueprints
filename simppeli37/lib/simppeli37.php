...
require_once( 'inc/class-simppeli37-google-fonts.php' );
...
require_once( 'class-simppeli37.php' );
require_once( 'class-simppeli37-assets.php' );

Simppeli37::bootstrap( array(
    new Simppeli37(),
    new Simppeli37_Assets(),
) );