...
/**
 * Class TwentyFifteen25_Google_Fonts
 */
final class TwentyFifteen25_Google_Fonts
{
    private $fonts = array();
    ...
    private function subsets()
    {
         ...
         */
        $subset = _x( 'no-subset', 'Add new subset (greek, cyrillic, devanagari, vietnamese)', 'twentyfifteen25' );
        if ( 'cyrillic' == $subset ) {
